        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppsPassword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CardNumber = table.Column<long>(type: "bigint", nullable: true),
                    ImageOfCard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ConfirmAccount = table.Column<int>(type: "int", nullable: true),
                    Money = table.Column<int>(type: "int", nullable: true),
                    SessionId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsPreparatory = table.Column<bool>(type: "bit", nullable: true),
                    IsSecondary = table.Column<bool>(type: "bit", nullable: true),
                    RechargedCard = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageOfCourse = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cards_Lectures_LectureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PFiles_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamAnswers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalMinutesWatched = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VideoWatchLogs_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_VideoWatchLogs_Videos_VideoId",
                        column: x => x.VideoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Results_ExamAnswers_ExamAnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamAnswers_ApplicationUserId",
                table: "ExamAnswers",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoWatchLogs_ApplicationUserId",
                table: "VideoWatchLogs",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoWatchLogs_VideoId",
                table: "VideoWatchLogs",
                column: "VideoId");
        }
